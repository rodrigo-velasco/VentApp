...
public class fragment_products extends Fragment
{
    ...
    public static fragment_products newInstance(int id)
    {
        user = id;
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        new WebPOST().execute("http://rodrigo-vr12.000webhostapp.com/listProductos.php?usuario=" + user);
    }
        ...
        protected void onPostExecute(String response)
        {
            try
            {
                ...
                for (int i = 0; i < jsonArray.length(); i++)
                {
                    ...
                    descripcion.add(json.getString("descripcion"));
                }
